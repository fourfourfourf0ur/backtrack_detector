...
DLL_FUNCTIONS g_DllFunctionTable = {
    ...
    BacktrackDetector::Connect,  // pfnClientConnect
...
NEW_DLL_FUNCTIONS g_NewDllFunctionTable = {
    NULL,  //! pfnOnFreeEntPrivateData()	Called right before the object's
           //! memory is freed.  Calls its destructor.
...
C_DLLEXPORT int GetEntityAPI2(DLL_FUNCTIONS *pFunctionTable,
  ...
  if (*interfaceVersion != INTERFACE_VERSION) {
    ALERT(at_logged, "%s version mismatch; requested=%d ours=%d", __FUNCTION__,
...
C_DLLEXPORT int GetNewDLLFunctions_Post(NEW_DLL_FUNCTIONS *pNewFunctionTable,
  ...
  memcpy(pNewFunctionTable, &g_NewDllFunctionTable_Post,
